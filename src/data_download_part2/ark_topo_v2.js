// =============================================================================
// MCTNet GEE — TOPOGRAPHY COVARIATES v2 — Part 2
// CORRECTION : ETOPO1 → USGS SRTM + unmask pour éviter perte de points
//
// POURQUOI ETOPO1 posait problème :
//   Résolution native ~1.8 km → très grossière pour pixels CDL à 30m
//   Bande 'bedrock' couvre aussi les fonds marins → masques inconsistants
//   dropNulls=True + pixels ETOPO1 null → perte de points → < 5000
//
// SOLUTION : USGS/SRTMGL1_003
//   ✅ Résolution native 30m → exactement la même que CDL (scale=30)
//   ✅ Couvre uniquement les terres émergées, Arkansas bien couvert
//   ✅ Bande 'elevation' = altitude terrain en mètres, sans ambiguïté
//   ✅ Pas de valeurs null dans le Delta Arkansas
//
// Variables (imposées par la prof) :
...
//
// PROCÉDURE (2 runs) :
//   ZONE_INDEX = 0 → ARK_TOPO_Z0.csv
//   ZONE_INDEX = 1 → ARK_TOPO_Z1.csv
// =============================================================================
