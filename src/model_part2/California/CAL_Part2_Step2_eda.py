...
def plot_distributions(raw, y, features):
    ...
    plt.suptitle('Distributions des covariables par classe — California',
                 fontsize=13, y=1.01)
    plt.tight_layout()
...
def plot_boxplots(raw, y, features):
    ...
    plt.suptitle('Boxplots des covariables par classe — California',
                 fontsize=13, y=1.01)
    plt.tight_layout()
...
def plot_correlation(raw, features):
    ...
    ax.set_title('Matrice de corrélation — 8 covariables — California',
                 fontsize=12, pad=15)
...
def plot_pca(cov_norm, y):
    ...
    ax.set_title('PCA — 8 covariables normalisées (n=3000 pts) — California',
                 fontsize=12)
...
def plot_importance(cov_norm, y, train_idx, features):
    ...
    ax.set_title('Importance des covariables — Random Forest — California',
                 fontsize=12)
    ax.grid(axis='y', alpha=0.3)
...
def main():
    print("=" * 60)
    print("Part 2 — Étape 2 : EDA covariables — California")
    print("=" * 60 + "\n")
    ...
    print("   → Lancer : python CAL_Part2_Step3_mctnetcov.py")
