...
def main():
    print("=" * 60)
    print("Step 1 - Prepare Part 3 Arkansas dataset")
    print("=" * 60)
    ...
    print(f"Feature tensor with vegetation indices : {x_full.shape}")
    ...
    print("\nFinal shapes:")
    print(f"  X_train {out['X_train'].shape}")
    print(f"  X_val   {out['X_val'].shape}")
